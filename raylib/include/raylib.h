...
// Trace log level_res
// NOTE: Organized by priority level_res
typedef enum {
...
typedef enum {
    ...
    GAMEPAD_AXIS_LEFT_TRIGGER  = 4,     // Gamepad back trigger left, pressure level_res: [1..-1]
    GAMEPAD_AXIS_RIGHT_TRIGGER = 5      // Gamepad back trigger right, pressure level_res: [1..-1]
} GamepadAxis;
...
RLAPI void SetTraceLogLevel(int logLevel);                        // Set the current threshold (minimum) log level_res
...
RLAPI void SetSoundVolume(Sound sound, float volume);                 // Set volume for a sound (1.0 is max level_res)
RLAPI void SetSoundPitch(Sound sound, float pitch);                   // Set pitch for a sound (1.0 is base level_res)
...
RLAPI void SetMusicVolume(Music music, float volume);                 // Set volume for music (1.0 is max level_res)
RLAPI void SetMusicPitch(Music music, float pitch);                   // Set pitch for a music (1.0 is base level_res)
...
RLAPI void SetAudioStreamVolume(AudioStream stream, float volume);    // Set volume for audio stream (1.0 is max level_res)
RLAPI void SetAudioStreamPitch(AudioStream stream, float pitch);      // Set pitch for audio stream (1.0 is base level_res)
